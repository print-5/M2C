      ...
      <div className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="ml-8">
            <Link 
              href="/categories"
              className="inline-block bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors font-semibold whitespace-nowrap"
            >
              View All Categories
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-6">
          {categories.map((category) => (
            ...
            >
              ...
              {/* Category Name */}
              <h3 className="text-base font-semibold text-gray-700 group-hover:text-[#3a75c4] transition-colors">
                {category.name}
              </h3>
            </Link>
          ))}
