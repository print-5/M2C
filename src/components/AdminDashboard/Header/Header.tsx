            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  <p className="text-sm font-medium text-[#222222]">Super Admin</p>
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                  ...
                  <div className="border-t border-gray-200 py-2 bg-gray-50">
                    <button className="flex items-center w-full px-4 py-2 text-sm text-[#222222] hover:bg-gray-100 transition-colors font-medium">
