  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-red-800">Returns & Refunds</h1>
        ...
        <Card className="border border-red-200 hover:border-red-300">
          <CardContent className="p-6">
            <div className="flex items-center">
              <RotateCcw className="w-8 h-8 text-red-700" />
              <div className="ml-4">
                <p className="text-sm font-medium text-slate-600">Total Returns</p>
                <p className="text-2xl font-bold text-red-800">{returns.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-red-800">{pendingReturns}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-red-800">${totalRefundAmount.toFixed(2)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="border border-red-200">
        <CardHeader className="bg-red-50 border-b border-red-200">
          <CardTitle className="text-red-800">Return Requests</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-red-200">
                  <th className="text-left py-3 px-4 text-red-800">Return ID</th>
                  <th className="text-left py-3 px-4 text-red-800">Order</th>
                  <th className="text-left py-3 px-4 text-red-800">Customer</th>
                  <th className="text-left py-3 px-4 text-red-800">Product</th>
                  <th className="text-left py-3 px-4 text-red-800">Reason</th>
              ...
              <tbody>
                {filteredReturns.map((returnItem) => (
                  <tr key={returnItem.id} className="border-b border-red-100 hover:bg-red-50">
                    <td className="py-3 px-4">
                      <div className="font-medium text-red-800">{returnItem.id}</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="font-medium text-red-800">{returnItem.orderNumber}</div>
                    </td>
                    <td className="py-3 px-4">
                      <div>
                        <div className="font-medium text-red-800">{returnItem.customer}</div>
                        <div className="text-sm text-slate-600">{returnItem.email}</div>
                      </div>
                    </td>
                    <td className="py-3 px-4">
                      <div>
                        <div className="font-medium text-red-800">{returnItem.product}</div>
                    ...
                    <td className="py-3 px-4">
                      <div className="font-medium text-red-800">${returnItem.amount.toFixed(2)}</div>
                    </td>
                    <td className="py-3 px-4">
