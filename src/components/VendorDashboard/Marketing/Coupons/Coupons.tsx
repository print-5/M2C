  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-red-800">Coupons & Discounts</h1>
        ...
        <Card className="border border-red-200 hover:border-red-300">
          <CardContent className="p-6">
            <div className="flex items-center">
              <Tag className="w-8 h-8 text-red-700" />
              <div className="ml-4">
                <p className="text-sm font-medium text-slate-600">Total Coupons</p>
                <p className="text-2xl font-bold text-red-800">{coupons.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-red-800">{activeCoupons}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-red-800">{totalUses}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCoupons.map((coupon) => (
          <Card key={coupon.id} className="border border-red-200 hover:border-red-300 hover:shadow-md transition-all">
            <CardHeader className="pb-3 bg-red-50 border-b border-red-200">
              <div className="flex justify-between items-start">
                <div className="flex items-center">
                  {getTypeIcon(coupon.type)}
                  <CardTitle className="ml-2 text-lg text-red-800">{coupon.code}</CardTitle>
                </div>
              ...
              <div className="space-y-3">
                ...
                {coupon.minOrderAmount && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-red-800">${coupon.minOrderAmount}</span>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-red-800">{coupon.endDate}</span>
                </div>

                <div className="flex gap-2 pt-3">
                  <Button variant="outline" size="sm" className="flex-1 hover:bg-red-50 hover:border-red-300">
      ...
      <Card className="border-dashed border-2 border-red-200 hover:border-red-400 transition-colors cursor-pointer">
        <CardContent className="p-12 text-center">
          <Plus className="w-12 h-12 text-red-400 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-red-800 mb-2">Create New Coupon</h3>
