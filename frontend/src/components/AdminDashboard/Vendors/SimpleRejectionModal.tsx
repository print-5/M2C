...
interface SimpleRejectionModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function SimpleRejectionModal({ 
  isOpen, 
  onClose, 
  onConfirm, 
  vendor, 
  isLoading = false 
}: SimpleRejectionModalProps) {
        ...
        <CardHeader className="border-b border-gray-200 bg-red-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-lg text-red-800">Reject Vendor</CardTitle>
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between text-sm">
              <span className={`${reason.length < 10 ? 'text-red-600' : 'text-green-600'}`}>
                {reason.length < 10 
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  ...
                  notified via email with your rejection reason.
                </p>
              </div>
            </div>
          </div>
